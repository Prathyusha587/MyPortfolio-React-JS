...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === "") {
      ...
      // Send email
      emailjs.send(
        "service_vdw3nxr",      // Replace with your EmailJS service ID
        "template_7ptz2nk",     // Replace with your EmailJS template ID
        {
          from_name: username,
          phone: phoneNumber,
          from_email: email,
        ...
        "3QvCtXBqRCO_lUycQ"       // Replace with your EmailJS public key
      )
      .then(() => {
